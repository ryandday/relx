...
protected:
    ...
    void TestTimezoneConversion(const std::string& input, 
                               std::time_t expected_utc_time_t, 
        ...
        EXPECT_EQ(actual_time_t, expected_utc_time_t) 
            << "Expected UTC time_t: " << expected_utc_time_t 
            << ", Got: " << actual_time_t
...
TEST_F(TimezoneParsingTest, FractionalSecondsWithTimezones) {
    ...
    TestTimezoneConversion("2023-12-25T15:30:45.123456+05:00", base_utc, "Microseconds with +5 offset");
    TestTimezoneConversion("2023-12-25T05:30:45.999999-05:00", base_utc, "Microseconds with -5 offset");
}
...
TEST_F(TimezoneParsingTest, NegativeTimezoneOffsets) {
    ...
    TestTimezoneConversion("2023-12-24T21:30:45-13:00", expected_utc, "-13 hours (extreme, previous day)");
...
TEST_F(TimezoneParsingTest, WeirdAndUnusualFormats) {
    ...
    TestTimezoneConversion("'2023-12-25 15:30:45+05:00'", expected_utc, "Quoted space format with timezone");
...
TEST_F(TimezoneParsingTest, CrossDayBoundaries) {
    ...
    TestTimezoneConversion("2022-12-31T19:00:00-05:00", midnight_utc, "Local 7pm prev day = UTC midnight");
}
...
TEST_F(TimezoneParsingTest, ExtremeFractionalSeconds) {
    ...
    TestTimezoneConversion("2023-12-25T15:30:45.123456789+05:00", base_utc, "Nanoseconds (truncated)");
...
TEST_F(TimezoneParsingTest, MidnightAndExtremeTimes) {
    ...
    TestTimezoneConversion("2023-12-26T04:59:59+05:00", almost_midnight, "Almost midnight with timezone");
}
...
TEST_F(TimezoneParsingTest, RoundTripConversion) {
    ...
    auto parsed_back = column_traits<std::chrono::system_clock::time_point>::from_sql_string(sql_string);

...
static_assert(ColumnTypeConcept<ValidColumnType>,
              "ValidColumnType should satisfy ColumnTypeConcept");

// is_column concept tests
static_assert(is_column<column<SimpleTable, "id", int>>,
              "column<id, int> should satisfy is_column");
static_assert(is_column<column<SimpleTable, "name", std::optional<std::string>>>,
              "column<name, std::optional<std::string>> should satisfy is_column");
...
static_assert(is_constraint<table_primary_key<&ValidTable::id>>,
              "primary_key should satisfy is_constraint");
static_assert(!is_constraint<column<SimpleTable, "id", int>>,
              "column should not satisfy is_constraint");
static_assert(!is_constraint<column<SimpleTable, "name", std::optional<std::string>>>,
              "column with std::optional should not satisfy is_constraint");

...
migrations::MigrationResult<migrations::Migration> test_generate_migration_between_versions(const std::string& from, const std::string& to) {
    if (from == "v1" && to == "v2") {
...
migrations::MigrationResult<migrations::Migration> test_generate_create_migration(const std::string& version) {
    if (version == "v1") {
        TestUsersV1 table;
...
migrations::MigrationResult<migrations::Migration> test_generate_drop_migration(const std::string& version) {
    if (version == "v1") {
        TestUsersV1 table;
...
TEST_F(CommandLineToolsTest, RunMigrationToolWithFileOutput) {
    char* argv[] = {
        ...
        const_cast<char*>("test_migration.sql")
    };
    int argc = 6;

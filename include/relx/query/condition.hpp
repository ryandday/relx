...
public:
  TypedInCondition(Expr expr, Range values) : expr_(std::move(expr)), values_(std::move(values)) {}
...
public:
  InCondition(Expr expr, Range values) : expr_(std::move(expr)), values_(std::move(values)) {}
